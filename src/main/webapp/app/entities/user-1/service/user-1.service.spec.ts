...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../user-1.test-samples';

import { User1Service } from './user-1.service';

const requireRestSample: IUser1 = {
...
describe('User1 Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a User1', () => {
      const user1 = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(user1).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a User1', () => {
      const user1 = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(user1).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addUser1ToCollectionIfMissing', () => {
      it('should add a User1 to an empty array', () => {
        const user1: IUser1 = sampleWithRequiredData;
      ...
      it("should add a User1 to an array that doesn't contain it", () => {
        const user1: IUser1 = sampleWithRequiredData;
        const user1Collection: IUser1[] = [sampleWithPartialData];
        expectedResult = service.addUser1ToCollectionIfMissing(user1Collection, user1);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(user1);
      });
      ...
      it('should add only unique User1 to an array', () => {
        const user1Array: IUser1[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const user1Collection: IUser1[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const user1: IUser1 = sampleWithRequiredData;
        const user12: IUser1 = sampleWithPartialData;
    ...
    describe('compareUser1', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareUser1(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareUser1(entity1, entity2);
        const compareResult2 = service.compareUser1(entity2, entity1);
