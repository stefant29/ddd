...
describe('B Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call A query and add missing value', () => {
      const b: IB = { id: 'CBA' };
      const a: IA = { id: '499df8e6-ce00-49e7-b9b6-0210cf54d1ee' };
      b.a = a;

      const aCollection: IA[] = [{ id: '78e5a3ab-f3b8-4009-a3d2-7d37831a5fa6' }];
    ...
    it('Should update editForm', () => {
      const b: IB = { id: 'CBA' };
      const a: IA = { id: '8bfd1962-aa5e-4c36-908c-45f8ddfbf036' };
      b.a = a;
